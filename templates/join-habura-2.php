...
$banner_content  = $banner_data['banner_join_2_content'];
$banner_button   = $banner_data['banner_join_2_button'];
?>

<section style="background-image: url('<?php echo $banner_bg_image; ?>')"
>
    <div class="elementor-container elementor-column-gap-default">
        <div class="elementor-row">
            <div class="make-column-clickable-elementor elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-2fb2702"
                 style="cursor: pointer;" data-column-clickable="https://bit.ly/3tYGBVW"
                 data-column-clickable-blank="_self" data-id="2fb2702" data-element_type="column">
                <div class="elementor-column-wrap elementor-element-populated">
                    <div class="elementor-widget-wrap">
                        <div class="elementor-element elementor-element-7234921 elementor-widget elementor-widget-heading"
                             data-id="7234921" data-element_type="widget" data-widget_type="heading.default">
                            <div class="elementor-widget-container">
                                <span class="elementor-heading-title elementor-size-default"><a
                                            href="https://bit.ly/3tYGBVW">בוא לכתוב בחבּוּרֶה!</a></span></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="make-column-clickable-elementor elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-049e5a5"
                 style="cursor: pointer;" data-column-clickable="https://bit.ly/3tYGBVW"
                 data-column-clickable-blank="_self" data-id="049e5a5" data-element_type="column">
                <div class="elementor-column-wrap elementor-element-populated">
                    <div class="elementor-widget-wrap">
                        <div data-dce-background-color="#CF050E"
                             class="elementor-element elementor-element-587d594 elementor-align-left elementor-mobile-align-left elementor-widget elementor-widget-button"
                             data-id="587d594" data-element_type="widget" data-widget_type="button.default">
                            <div class="elementor-widget-container">
